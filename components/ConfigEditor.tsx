  ...
  return (
    <div className="space-y-2">
      ...
      {configs.map((c, i) => {
        ...
        return (
          <div key={i} className="bg-navy-deep border border-navy-border rounded-lg px-4 py-3.5 flex items-center gap-4 group"
            ...
            <input
              className="input w-36 text-center flex-shrink-0"
              value={c.value}
              onChange={(e) => {
                const upd = [...configs];
      ...
      {!addOpen ? (
        ...
        <div className="bg-navy-deep border border-navy-border rounded-lg p-4 animate-slide-up" style={{ borderRadius: "var(--radius-md)" }}>
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <button className="btn-primary text-xs py-2 px-3 flex-shrink-0" onClick={handleAdd}>Add</button>
